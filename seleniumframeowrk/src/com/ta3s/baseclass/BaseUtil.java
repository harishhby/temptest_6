...
//			driver = new InternetExplorerDriver();
	...
	public void getAtuReportPath() throws IOException {
		try {
			...
			System.setProperty(GetPath.getBasePath()+File.separator+"atu.reporter.config", pathAtuReport);
	...
	public String getAbsolutePath() throws IOException {
		String path = new File(GetPath.getBasePath()+"src/atu.properties").getAbsolutePath();
